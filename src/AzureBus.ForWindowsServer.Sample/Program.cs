namespace AzureBus.Sample
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IBus bus = AzureCloud
                .ConfigureBus()
                ////.WithPublishConfiguration((c) => c.WithTopicName((t) => { return t.FullName.ToLowerInvariant(); }))
                ////.WithSubscribtionConfiguration((c) => c.WithTopicName((t) => { return t.FullName.ToLowerInvariant(); }))
                .CreateBus();
